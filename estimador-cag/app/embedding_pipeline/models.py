"""Modelos ORM de la persistencia vectorial (documents / chunks).

`metadata` es un atributo reservado en los modelos declarativos de SQLAlchemy,
asi que el atributo Python es `metadata_`, mapeado a la columna `"metadata"`.
"""
